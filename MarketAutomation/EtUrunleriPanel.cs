...
{
    public partial class EtUrunleriPanel : Form
    {
        int sayi1;
        int sayi2;
        int islemTip;
        ...
        public EtUrunleriPanel()
        {
            InitializeComponent();
            txt_islem.Text = "";
        }

        private void EtUrunleriPanel_Load(object sender, EventArgs e)
        {
        ...
        private void btn_baklagilPanel_Click(object sender, EventArgs e)
        {
